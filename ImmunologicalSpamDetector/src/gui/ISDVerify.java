...
public class ISDVerify extends JFrame {
	...
	public ISDVerify(JFrame frmImmunologicalSpamDetector, String filename) {
		...
		results = new ArrayList<Email>();
		main = frmImmunologicalSpamDetector;
		setIconImage(Toolkit.getDefaultToolkit().createImage("res/guiImages/verify.png"));
		...
		lblAnalysing.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage("res/guiImages/analysing.png")));
